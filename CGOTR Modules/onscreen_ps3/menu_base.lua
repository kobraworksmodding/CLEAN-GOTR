...
function menu_horz_init(menu_data)
	...
	if Menu_horz_active.num_items > 1 then
		...
		vint_set_property(h, "image", get_rb_button())
		vint_set_property(h, "visible", true)
		...
		vint_set_property(h, "image", get_lb_button())
		vint_set_property(h, "visible", true)
...
function btn_tips_init()
	...
	vint_set_property(Menu_base_btn_tips[3].independent_bitmap_h, "image", "ui_ctrl_ps3_btn_r3")
