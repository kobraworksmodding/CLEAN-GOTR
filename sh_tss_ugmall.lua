...
-- Added by IdolNinja. These variables are used in the script for the cutscenes for stability instead of calling them directly
	...
	CUTSCENE_IN = 		"sh_tss_ugmallct1"
	CUTSCENE_MID =		"sh_tss_ugmallct2"
	MISSION_NAME =		"sh_tss_ugmall"
...
function sh_tss_ugmall_phaseTwo()
	...
	delay(3)
	cutscene_play(CUTSCENE_MID,"sh_tss_ugmall_$GUltorThugs",teleport_points,true)	
