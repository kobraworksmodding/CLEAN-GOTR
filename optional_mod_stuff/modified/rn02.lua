...
function rn02_vehicle_destroyed_failure()
	...
	mission_end_failure(MISSION_NAME, HELPTEXT_FAILURE_CONVERTIBLE)
end

function rn02_dealer_died_failure()
	mission_end_failure(MISSION_NAME, HELPTEXT_FAILURE_DEALER_DIED)
end	

function rn02_fence_died_failure()
	-- End the mission, fence died
	mission_end_failure(MISSION_NAME, HELPTEXT_FAILURE_FENCE)
end
