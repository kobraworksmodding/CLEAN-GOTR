...
-- Added by IdolNinja. These variables are used in the script for the cutscenes for stability instead of calling them directly
	...
	CUTSCENE_IN = 		"sh_bh_docksct1"
	MISSION_NAME =		"sh_bh_docks"
	MISSION_FAIL_GETBACK =	"MSN_SH_BH_DOCKS_GETBACK_FAIL"
	MISSION_FAIL =		"sh_bh_docks_fail"
	MISSION_FAIL_THREE = 	"sh_bh_docks_fail_three"
	MISSION_FAIL_FOUR =	"sh_bh_docks_fail_four"
...
mission_end_failure(MISSION_NAME, MISSION_FAIL_GETBACK) 
end
...
--mission_debug("weapon=  "..weapon)
	...
	if type == "vehicle" and name == "sh_bh_docks_$v001" and weapon == "satchel" then
		mission_end_failure(MISSION_NAME,MISSION_FAIL_THREE)
	end
...
function sh_bh_docks_vehicle_destroyed_fail()
	mission_end_failure(MISSION_NAME, MISSION_FAIL_FOUR) --You destroyed the truck!
end

function sh_bh_docks_vehicle_destroyed_fail_passenger()
	mission_end_failure(MISSION_NAME, MISSION_FAIL) --You destroyed the truck!
end

function sh_bh_docks_fail_convoy()
	mission_end_failure(MISSION_NAME,"sh_bh_docks_fail_two")
end
