...
-- Global Variables --
	...
	CRIB_TELE_IN 	= "suburbs_$SB_aisha_in"
	CRIB_TELE_OUT 	= "suburbs_$SB_aisha_out"
	CRIB_PURCHASE 	= "cribs_sr2_city_$AISHA_purchase"
	CRIB_TV 	= "cribs_sr2_city_$SB_Aisha_tv"
	CRIB_CLOTHES 	= "cribs_sr2_city_$SB_Aisha_clothes"
	CRIB_WEAPONS 	= "cribs_sr2_city_$SB_Aisha_weapons"
	CRIB_CASH	= "cribs_sr2_city_$SB_Aisha_cash"
...
CUTSCENE_IN = 		"tssp03-01"
CUTSCENE_OUT = 		"tssp03-02"
MISSION_NAME =		"tss03"
...
function tss03_start(checkpoint, is_restart)
	...
	if (checkpoint == MISSION_START_CHECKPOINT) then
		if (not is_restart) then
			cutscene_play(CUTSCENE_IN, {GROUP_START, GROUP_START_VEHICLE}, {LOCATION_START, LOCATION_START_PLAYER_2}, false)
	...
	--disable all crib triggers
	trigger_enable( CRIB_TELE_IN, false )
	trigger_enable( CRIB_TELE_OUT, false )
	trigger_enable( CRIB_PURCHASE, false )
	trigger_enable( CRIB_TV, false )
	trigger_enable( CRIB_CLOTHES, false )
	trigger_enable( CRIB_WEAPONS, false )
	trigger_enable( CRIB_CASH, false )
...
function tss03_cleanup()
	...
	--reenable all crib triggers
	trigger_enable( CRIB_TELE_IN, true )
	trigger_enable( CRIB_TELE_OUT, true )
	trigger_enable( CRIB_PURCHASE, true )
	trigger_enable( CRIB_TV, true )
	trigger_enable( CRIB_CLOTHES, true )
	trigger_enable( CRIB_WEAPONS, true )
	trigger_enable( CRIB_CASH, true )
...
function tss03_failure()
	...
	mission_end_failure(MISSION_NAME, "tss03_gat_died")
end

function tss03_abandon_gat()
	-- End the mission since Gat was abandoned
	mission_end_failure(MISSION_NAME, "tss03_gat_abandoned")
end
