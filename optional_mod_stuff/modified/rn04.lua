...
function rn04_complete()
	...
	mission_end_success(MISSION_NAME, CUTSCENE_OUT, {"player_respawns_$DT_hospital", "player_respawns_$DT_hospital"})
end
...
function rn04_failure_car_destroyed()
	...
	mission_end_failure(MISSION_NAME, HELPTEXT_FAILURE_CAR_DESTROYED)
end
