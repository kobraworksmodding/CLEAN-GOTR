...
-- Cutscenes --
	CUTSCENE_IN =						"br07-1.bik"
	CUTSCENE_OUT =						"br07-2.bik"
...
function bh07_success_all_lieutenants_killed()
	delay(3)
	mission_end_success("bh07", "br07-02")
end

function bh07_failure_shop_owner_died()
	mission_end_failure("bh07", TEXT_SHOP_OWNER_DIED)
end

function bh07_failure_store_damage()
	mission_end_failure("bh07", TEXT_TOO_MUCH_DAMAGE)
end
