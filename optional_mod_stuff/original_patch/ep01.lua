...
function ep01_complete()
	...
	--bink_play_movie("tsse01-2.bik")

	-- End the mission with success
	mission_end_success("ep01", "tsse01_02", {NAVPOINT_LOCAL_SUCCESS,NAVPOINT_REMOTE_SUCCESS})
end
...
function ep01_failure_shaundi_abandoned()
	...
	mission_end_failure("ep01", HELPTEXT_FAILURE_SHAUNDI_ABANDONED)
end

function ep01_failure_shaundi_died()
	-- End the mission, Shaundi died
	mission_end_failure("ep01", HELPTEXT_FAILURE_SHAUNDI_DIED)
end

function ep01_failure_pierce_abandoned()
	-- End the mission, Pierce abandoned
	mission_end_failure("ep01", HELPTEXT_FAILURE_PIERCE_ABANDONED)
end

function ep01_failure_pierce_died()
	-- End the mission, Pierce died
	mission_end_failure("ep01", HELPTEXT_FAILURE_PIERCE_DIED)
end
